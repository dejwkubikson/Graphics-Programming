...
public:
	...
	void setFloat(const std::string &name, float value) const
	{
		...
		if ((glGetUniformLocation(program, name.c_str()) == -1))
		{
			std::cerr << "Unable to load shader: " << name.c_str() << " with value: " << value << std::endl;
			__debugbreak();
		}
	}
	// ------------------------------------------------------------------------
...
private:
	...
	static const unsigned int NUM_GEO_SHADERS = 3; // number of shaders when using geometry shader
	...
	GLuint shadersGEO[NUM_GEO_SHADERS];
